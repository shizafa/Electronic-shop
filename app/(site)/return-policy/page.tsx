...
export const metadata: Metadata = {
  title: t("footer.returnsWarranty"),
};

// /return-policy route: renders the admin-authored return policy Markdown. 404s when the
  ...
  return (
    <div className="container-page max-w-2xl py-10">
      ...
      <div
        ...
        dangerouslySetInnerHTML={{ __html: renderMarkdown(settings.returnPolicy) }}
      />
    </div>
  );
}
