...
// data-bs-toggle="modal" data-bs-target="#compareviewModal" dropped — links straight to
// /compare, same reasoning as the account link. Badge only renders when non-empty (template
...
export function StickyHeaderCompareLink() {
  ...
  return (
          <li className="rbt-access-box rbt-scroll-trigger fade_in animation-order-4 tooltips tooltip-distance-lg  d-none d-lg-flex" data-tooltip="Compare" data-tooltip-position="bottom">
            <Link className="rbt-round-btn has-rbt-md-fsize" href="/compare">
